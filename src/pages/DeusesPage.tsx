...
function matches(d: LocaleCatalog["deuses"][number], q: string) {
  ...
  return (
    <div className="w-full min-w-0">
      <ListPageStickyHeader>
        <PageHeader
          title={t("pages.deuses.title")}
          description={t("pages.deuses.description")}
        ...
        <div className="flex flex-col items-start gap-3">
          <SearchField
            value={q}
            onChange={setQ}
            placeholder={t("pages.deuses.filterPlaceholder")}
            id="deuses-search"
          />
