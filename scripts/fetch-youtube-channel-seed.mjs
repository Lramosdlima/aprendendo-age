...
const CHANNELS = [
  ...
  { handle: "AoMRetoldBrasil", sortOrder: 16 },
  { handle: "WololoBRAOM", sortOrder: 17 },
  { handle: "HUSKSUPPE", sortOrder: 18 },
  { handle: "mooseaom", sortOrder: 19 },
  { handle: "balerionaom", sortOrder: 20 },
  { handle: "TavernadoLug", sortOrder: 21 },
  { handle: "Gabriel_AoM", sortOrder: 22 },
  { handle: "BoitTV", sortOrder: 23 },
  { handle: "DeitiesofDeath", sortOrder: 24 },
  { handle: "HunkAoM", sortOrder: 25 },
  { handle: "TheRapll", sortOrder: 26 },
  { handle: "NoobbSA", sortOrder: 27 },
  { handle: "HimuraAoM", sortOrder: 28 },
  { handle: "LeonidasBaianoBr", sortOrder: 29 },
  { handle: "Sementerj", sortOrder: 30 },
  { handle: "NaddoStrategy", sortOrder: 31 },
];
