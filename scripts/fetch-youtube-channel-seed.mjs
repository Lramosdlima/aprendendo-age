...
const CHANNELS = [
  { handle: "kevenaom", sortOrder: 12 },
  { handle: "Milanogods", sortOrder: 13 },
  { handle: "oCafeina", sortOrder: 14 },
  { handle: "Forkxx", sortOrder: 15 },
  { handle: "scoobymaniaco", sortOrder: 16 },
  { handle: "ProfessorAjax", sortOrder: 17 },
  { handle: "AoMRetoldBrasil", sortOrder: 18 },
  { handle: "WololoBRAOM", sortOrder: 19 },
  { handle: "HUSKSUPPE", sortOrder: 20 },
  { handle: "mooseaom", sortOrder: 21 },
  { handle: "balerionaom", sortOrder: 22 },
  { handle: "TavernadoLug", sortOrder: 23 },
  { handle: "Gabriel_AoM", sortOrder: 24 },
  { handle: "BoitTV", sortOrder: 25 },
  { handle: "DeitiesofDeath", sortOrder: 26 },
  { handle: "HunkAoM", sortOrder: 27 },
  { handle: "TheRapll", sortOrder: 28 },
  { handle: "NoobbSA", sortOrder: 29 },
  { handle: "HimuraAoM", sortOrder: 30 },
  { handle: "LeonidasBaianoBr", sortOrder: 31 },
  { handle: "Sementerj", sortOrder: 32 },
  { handle: "NaddoStrategy", sortOrder: 33 },
];
